...
//	@javax.persistence.Id
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", description=" + description + ", price=" + price
				+ ", category=" + category + ", modelNumber=" + modelNumber + ", color=" + color + ", soldCount="
				+ soldCount + ", rating=" + rating + ", lunchedYear=" + lunchedYear + ", postedDateAndTime="
				+ postedDateAndTime + ", tags=" + tags + "]";
	}
